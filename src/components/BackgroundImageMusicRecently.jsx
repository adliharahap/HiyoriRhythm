...
const BackgroundImageMusicRecently = () => {
    ...
    return (
        <>
        <View style={{height: 300, width: '100%', position: 'absolute', top: 0}}>
            <Image source={require('../assets/images/test.jpg')} style={{height: 300, width: '100%', resizeMode: 'cover'}} blurRadius={1.5} />
            <View style={{backgroundColor: 'rgba(0,0,0,0.3)', height: 300, width: '100%', position: 'absolute', top: 0}}></View>
        </View>
        <View style={{height: 60, width: '100%', flexDirection: 'row', position: 'absolute', top: 0, paddingVertical: 10, zIndex: 999}}>
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                <Text style={{fontSize: 22, fontFamily: 'Roboto-Bold', color: '#fff', textShadowColor: 'rgba(0, 0, 0, 0.75)', textShadowOffset: {width: -1, height: 1}, textShadowRadius: 10}}>Hiyori Rhythm</Text>
            </View>
            <View style={{flex: 1}}>
