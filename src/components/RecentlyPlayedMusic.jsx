...
const RecentlyPlayedMusic = () => {
    ...
    return (
        <View style={{width: '100%', position: 'absolute', top: -130, zIndex: 99}}>
            <View style={{ flexDirection: 'row', height: 170,}}>
                ...
                <View style={{flex: 1, justifyContent: 'left', alignItems: 'center'}}>
                    <View style={{ width: '100%', paddingTop: 15, paddingBottom: 15}}>
                        <Text style={{fontSize: 20, fontFamily: 'Montserrat-SemiBold', color: '#fff', textShadowColor: 'rgba(0, 0, 0, 0.75)', textShadowOffset: {width: -1, height: 1}, textShadowRadius: 10, paddingBottom: 10}} numberOfLines={1}>
                            Recently Played
                        </Text>
                        <Text style={{fontSize: 16, fontFamily: 'Montserrat-Regular', color: '#f2f2f2',textShadowRadius: 10}} numberOfLines={3}>
                            Ariana Grande, The Weeknd - Love Me Harder (Official Lyric Video)
                        </Text>
                    </View>
                    <View style={{flex: 1, width: '100%', alignItems: 'center',justifyContent: 'space-between', paddingHorizontal: 20, flexDirection: 'row'}}>
                        <View style={{height: '100%', justifyContent: 'center', alignItems: 'center'}}>
                            <Text style={{fontSize: 16, fontFamily: 'Montserrat-Regular', color: '#f2f2f2'}}>03 : 24</Text>
                        </View>
                        <TouchableOpacity>
                            <View style={{width: 100, height: '100%', backgroundColor: '#FFDF00', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 10, borderRadius: 30, borderWidth: 1}}>
                                <View>
