...
const MusicCountAndSort = ({allmusic}) => {
    ...
    return (
        <View style={{height: 60, width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
            <View style={{width: 110, justifyContent: 'center', alignItems: 'center'}}>
                <Text style={{fontSize: 16, color: '#fff', fontFamily: 'Roboto-Regular'}}>All Music :</Text>
                <Text style={{fontSize: 14, color: 'yellow', fontFamily: 'Roboto-Regular'}}>{allmusic}</Text>
            </View>
            <TouchableOpacity onPress={() => dispatch(showModal())} style={{width: 120, justifyContent: 'center', alignItems: 'center'}}>
...
export default MusicCountAndSort;