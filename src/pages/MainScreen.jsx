...
const MainScreen = () => {
    ...
    return (
        ...
        <Tab.Navigator screenOptions={({ route }) => ({
            ...
            // tabBarActiveBackgroundColor : '#582FFF',
            ...
            <Tab.Screen name="Home" component={HomeScreen} options={{tabBarIcon: ({focused, color, size}) => {
                return (
                    <View style={{
                        flexDirection: 'row',
                        alignItems: 'center',
                        backgroundColor: focused ? '#582FFF' : 'transparent',
                        borderRadius: 50,
                        paddingHorizontal: 10,
                        paddingVertical: 5
                    }}>
                        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
                            <Path fill-rule="evenodd" clip-rule="evenodd" d="M21.4498 10.275L11.9998 3.1875L2.5498 10.275L2.9998 11.625H3.7498V20.25H20.2498V11.625H20.9998L21.4498 10.275ZM5.2498 18.75V10.125L11.9998 5.0625L18.7498 10.125V18.75H14.9999V14.3333L14.2499 13.5833H9.74988L8.99988 14.3333V18.75H5.2498ZM10.4999 18.75H13.4999V15.0833H10.4999V18.75Z" fill={focused ? "#FFFFFF" : color}/>
                        </Svg>
                    </View>
                )
            }}}/>
            <Tab.Screen name="Search" component={SearchMusicScreen} options={{tabBarIcon: ({focused, color, size}) => {
                return (
                    <View style={{
                        flexDirection: 'row',
                        alignItems: 'center',
                        ...
                        <Svg height={size} viewBox="0 -960 960 960" width={size}  fill={focused ? "#FFFFFF" : color}><Path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></Svg>
                    </View>    
                )
            }}}/>
            <Tab.Screen name="Music" component={ListMusicScreen} options={{tabBarIcon: ({focused, color, size}) => {
                return (
                    <View style={{
                        flexDirection: 'row',
                        alignItems: 'center',
            ...
            <Tab.Screen name="Playlist" component={Playlistcreen} options={{tabBarIcon: ({focused, color, size}) => {
                return (
                    <View style={{
                        ...
                        <Svg height={size} viewBox="0 -960 960 960" width={size} fill={focused ? "#FFFFFF" : color}><Path d="M500-360q42 0 71-29t29-71v-220h120v-80H560v220q-13-10-28-15t-32-5q-42 0-71 29t-29 71q0 42 29 71t71 29ZM320-240q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320Zm0-80h480v-480H320v480ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Zm160-720v480-480Z"/></Svg>
                    </View>    
                )
            }}}/>
            <Tab.Screen name="Profile" component={Profiles} options={{tabBarIcon: ({focused, color, size}) => {
                return (
                    <View style={{
                        flexDirection: 'row',
                        alignItems: 'center',
                        ...
                        <Svg fill={focused ? "#FFFFFF" : color} width={size} height={size} viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg"><Path d="M 28.0117 27.3672 C 33.0508 27.3672 37.3867 22.8672 37.3867 17.0078 C 37.3867 11.2187 33.0274 6.9297 28.0117 6.9297 C 22.9961 6.9297 18.6367 11.3125 18.6367 17.0547 C 18.6367 22.8672 22.9961 27.3672 28.0117 27.3672 Z M 13.2930 49.0703 L 42.7305 49.0703 C 46.4101 49.0703 47.7226 48.0156 47.7226 45.9531 C 47.7226 39.9062 40.1523 31.5625 28.0117 31.5625 C 15.8477 31.5625 8.2774 39.9062 8.2774 45.9531 C 8.2774 48.0156 9.5898 49.0703 13.2930 49.0703 Z"/></Svg>
                    </View>    
                )
            }}}/>
        </Tab.Navigator>
